This project is about using machine learning to create a model that predicts which passengers survived the Titanic shipwreck

This folder includes 4 files 
1. train.csv (for train model)
